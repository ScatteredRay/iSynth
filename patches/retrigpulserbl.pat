...
BLTriangle osc(detune, osc_retrigger)

#filter
400 EnvelopeGenerator env(touch, 0.01, 0.7, 0.5, 0.1)
400 Rescaler cutoff_env(env, 400, 1200)
400 Rescaler cutoff_y(y, 0.25, 1)
400 Multiply cutoff(cutoff_y, cutoff_env)
400 Add cutoff_offset(cutoff, freq)
Filter filter(osc, cutoff_offset, 0.7)

#decimator
200 Rescaler trigger_freq_coef(y, 8, 40)
200 Multiply trigger_freq(freq, trigger_freq_coef)
200 Clipper limited_trigger_freq(trigger_freq, 0, 22050)
